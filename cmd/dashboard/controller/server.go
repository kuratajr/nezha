...
func updateServer(c *gin.Context) (any, error) {
	...
	s.Zone = sf.Zone
	s.ProjectID = sf.ProjectID
	s.ClusterID = sf.ClusterID

	// ConfigDetail update cho ConfigDetail
	if sf.ConfigDetail.Name != "" {
		s.ConfigDetail.Name = sf.ConfigDetail.Name
	}
	if sf.ConfigDetail.DisplayName != "" {
		s.ConfigDetail.DisplayName = sf.ConfigDetail.DisplayName
	}
	if sf.ConfigDetail.Uid != "" {
		s.ConfigDetail.Uid = sf.ConfigDetail.Uid
	}
	if sf.ConfigDetail.CreateTime != "" {
		s.ConfigDetail.CreateTime = sf.ConfigDetail.CreateTime
	}
	if sf.ConfigDetail.UpdateTime != "" {
		s.ConfigDetail.UpdateTime = sf.ConfigDetail.UpdateTime
	}
	if sf.ConfigDetail.Etag != "" {
		s.ConfigDetail.Etag = sf.ConfigDetail.Etag
	}
	if sf.ConfigDetail.State != "" {
		s.ConfigDetail.State = sf.ConfigDetail.State
	}
	if sf.ConfigDetail.Host != "" {
		s.ConfigDetail.Host = sf.ConfigDetail.Host
	}
	if sf.ConfigDetail.StartTime != "" {
		s.ConfigDetail.StartTime = sf.ConfigDetail.StartTime
	}
	if sf.ConfigDetail.Token != "" {
		s.ConfigDetail.Token = sf.ConfigDetail.Token
	}
	// Cập nhật boolean field
	s.ConfigDetail.SatisfiesPzi = sf.ConfigDetail.SatisfiesPzi
	// Cập nhật map fields nếu có
	if sf.ConfigDetail.Annotations != nil {
		s.ConfigDetail.Annotations = sf.ConfigDetail.Annotations
	}
	if sf.ConfigDetail.Env != nil {
		s.ConfigDetail.Env = sf.ConfigDetail.Env
	}
	if sf.ConfigDetail.RuntimeHost != nil {
		s.ConfigDetail.RuntimeHost = sf.ConfigDetail.RuntimeHost
	}
...
func updateServerDetail(c *gin.Context) (any, error) {
	idStr := c.Param("id")
	id, err := strconv.ParseUint(idStr, 10, 64)
	if err != nil {
		return nil, err
